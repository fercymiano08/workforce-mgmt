...
class WorkingDaysTest extends TestCase
{
    ...
    public function test_only_a_service_may_ask_over_http(): void
    {
        $this->postJson('/api/internal/working-days', ['employeeId' => 'E1', 'startDate' => '2030-01-14', 'endDate' => '2030-01-15'])
            ->assertStatus(403);

        $this->withHeader('X-Service-Token', 'wfp-intel-2026-secret-9f3a7c1e')
            ->postJson('/api/internal/working-days', ['employeeId' => 'E1', 'startDate' => '2030-01-14', 'endDate' => '2030-01-15'])
