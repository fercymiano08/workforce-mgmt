 ...
 *
 * This puts the two standard templates in place on any database that does not
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        foreach ([
            ...
            ['id' => 'SHIFT005', 'name' => 'Overtime Shift', 'start_time' => '17:00:00', 'end_time' => '21:00:00', 'color' => '#EF4444'],
        ] as $shift) {
