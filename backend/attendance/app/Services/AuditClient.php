 ...
 *
 * 'remote' (production): POSTs to the Core service (system of record for the
 * audit trail). 'local' (tests): events are skipped - the Core service's own
 * test suite covers the endpoint, and no local replica exists by design.
 */
class AuditClient
{
    /**
