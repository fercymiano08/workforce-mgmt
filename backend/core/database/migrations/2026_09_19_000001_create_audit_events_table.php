...
return new class extends Migration
{
     ...
     *  - Writes come only from the machine-to-machine endpoint guarded by the
     *    shared SERVICE_TOKEN, so peer microservices never touch this table
     *    directly and the frontend has no write path into it.
     */
