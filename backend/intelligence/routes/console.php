...
// this covers everything else (attendance, leaves, shifts, timesheets,
// settings) with a 1-minute worst case instead of "only when someone
// remembers to run snapshot:sync by hand". Started by start-all.ps1 via
// `schedule:work`.
